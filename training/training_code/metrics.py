# Adapted from https://github.com/guillaumegenthial/tf_metrics
"""Multiclass metrics - updated to support TF 2.x"""
...
def compute_cm(labels, predictions, num_classes, weights):
    '''Convenience function to get only the confusion matrix'''
    cm, _ = _streaming_confusion_matrix(
