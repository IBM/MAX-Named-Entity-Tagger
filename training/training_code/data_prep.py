...
parser.add_argument('--glove_cased', type=bool, default=False,
    help='If False, word vocab is generated for lowercase words only (chars are still cased). ' + 
    'This MUST be matched with same setting in training script (default: False)')
